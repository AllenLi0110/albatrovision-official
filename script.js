...
const pageCopy = {
  zh: {
    ...
    "status.activeTitle": "運作中",
    "status.vessel": "船隻狀態",
    "status.networkTitle": "網路",
    "status.starlink": "Starlink",
    "status.gatewayTitle": "Edge Gateway",
    "status.online": "在線",
    "status.camerasTitle": "4 鏡頭",
    "status.allOnline": "全數在線",
    "stats.camera": "鏡頭軌道",
  ...
  en: {
    ...
    "status.activeTitle": "Active",
    "status.vessel": "Vessel status",
    "status.networkTitle": "Network",
    "status.starlink": "Starlink",
    "status.gatewayTitle": "Edge Gateway",
    "status.online": "Online",
    "status.camerasTitle": "4 Cameras",
    "status.allOnline": "All online",
